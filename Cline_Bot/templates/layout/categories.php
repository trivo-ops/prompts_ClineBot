<?php
/**
 * Categories Layout - Consistent with products/auth styling
 *
...
<head>
    ...
    <title>
        <?= h($this->fetch('title') ?: 'Categories Management') ?>
    </title>
    <?= $this->Html->meta('icon') ?>
...
<body>
    <nav class="top-nav">
        <div class="top-nav-title">
            <a href="<?= $this->Url->build('/') ?>"><span>Categories</span> Management</a>
        </div>
    ...
    <footer>
        <div class="container">
            <p>&copy; <?= date('Y') ?> Categories Management System</p>
        </div>
    </footer>
</body>
</html>
